...
The generated SDK depends on third-party libraries. Include all of the scripts in your webpage
    ...
    <script type="text/javascript" src="PetStoreClient.js"></script>
...
```
var PetStoreClient = PetStoreClientFactory.newClient();
```
...
PetStoreClient.methodName(params, body, additionalParams)
